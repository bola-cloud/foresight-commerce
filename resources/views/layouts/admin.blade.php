...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset("theme/assets/images/logo/logo.jpg")}}">
            ...
            <div class="main-menu menu-static menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
                <div class="main-menu-content">
                    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                        ...
                        <!-- Products -->
                        <li class="nav-item has-sub {{ Request::is('admin/products*') ? 'open' : '' }}">
                            ...
                            <ul class="menu-content">
                                <li class="{{ Route::currentRouteName() == 'admin.products.index' ? 'active' : '' }}">
                                    <a href="{{ route('admin.products.index') }}">
                                        <i class="la la-list"></i>
                                        <span class="menu-item">{{ __('lang.product_list') }}</span>
                                    </a>
                                </li>
                                <li class="{{ Route::currentRouteName() == 'admin.products.create' ? 'active' : '' }}">
                                    <a href="{{ route('admin.products.create') }}">
                                        <i class="la la-plus-circle"></i>
                                        <span class="menu-item">{{ __('lang.add_product') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <!-- Ad Sliders -->
                        <li class="nav-item has-sub {{ Request::is('admin/adsliders*') ? 'open' : '' }}">
                            <a href="javascript:void(0)">
                                <i class="la la-sliders"></i>
                                <span class="menu-title">{{ __('lang.ad_sliders') }}</span>
                            </a>
                            <ul class="menu-content">
                                <li class="{{ Route::currentRouteName() == 'admin.adsliders.index' ? 'active' : '' }}">
                                    <a href="{{ route('admin.adsliders.index') }}">
                                        <i class="la la-list"></i>
                                        <span class="menu-item">{{ __('lang.ad_slider_list') }}</span>
                                    </a>
                                </li>
                                <li class="{{ Route::currentRouteName() == 'admin.adsliders.create' ? 'active' : '' }}">
                                    <a href="{{ route('admin.adsliders.create') }}">
                                        <i class="la la-plus-circle"></i>
                                        <span class="menu-item">{{ __('lang.add_ad_slider') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
