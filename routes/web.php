...
Route::group([
    ...
    Route::post('/categories/move', [\App\Http\Controllers\Admin\CategoryController::class, 'move'])->name('admin.categories.move');
    ...
    Route::post('/blogs/move', [\App\Http\Controllers\Admin\BlogController::class, 'move'])->name('admin.blogs.move');
